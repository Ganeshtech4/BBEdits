...
const About = () => {
  return (
    <div className="text-black dark:text-white pt-44">
      <br />
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">BBEdits?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than BB Edits, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of BB Edits, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created BB Edits &ndash; to provide new
          ...
          <br />
          <br />
          At BB Edits, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But BB Edits is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With BB Edits by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the BB Edits family today and
        ...
        <br />
        <span className="text-[22px]">Anil Bangaru</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of BB Edits
        </h5>
        <br />
        <br />
        <br />
